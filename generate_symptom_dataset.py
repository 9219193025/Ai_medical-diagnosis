...
for _ in range(5000):                     # Create 5000 patient examples
    disease = random.choice(diseases)
    symptoms_active = random.sample(symptoms, k=random.randint(3, 10))

    row = {s: 0 for s in symptoms}        # Default 0
    for s in symptoms_active:
        row[s] = 1
...
print("Dataset created successfully: symptom_dataset.csv")
print("Rows:", len(df))
